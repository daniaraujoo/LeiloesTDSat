    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try {
            ...
            if (produtodao.cadastrarProduto(produto)) {
                JOptionPane.showMessageDialog(null, "O produto " +produto.getNome()+ " foi cadastrado com sucesso!");
            ...
            JOptionPane.showMessageDialog(null, "O produto não foi cadastrado.", "Erro", 0);
        }
